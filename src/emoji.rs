...
//! backgrounds. The lever is Unicode presentation, not the font: Pango picks a
//! color emoji font for any character that defaults to emoji presentation,
//! ignoring the requested family.
...
pub fn force_text_presentation(text: &str) -> std::borrow::Cow<'_, str> {
